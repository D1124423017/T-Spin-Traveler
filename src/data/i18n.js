export const translations = {
  zh: {
    ...
    startWorldHint: "NOA 穿過古文明裂隙，把每一次消行變成戰鬥指令。",
    startPanelHint: "先進無盡模式，或從主線關卡挑戰埃及第一章。",
    endless: "無盡模式",
    ...
    menuHeroClick2: "準備好了嗎？古文明裂隙正在等我們。",
  ...
  en: {
    ...
    startWorldHint: "NOA crosses the ancient rift and turns every line clear into a battle command.",
    startPanelHint: "Start Endless, or challenge Egypt Chapter I from Main Stages.",
    endless: "Endless",
    ...
    menuHeroClick2: "Ready? The ancient rift is waiting.",
    ...
    toastRunStart: "Rift route opened",
