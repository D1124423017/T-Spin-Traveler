export const translations = {
  zh: {
    ...
    "special.none": "無特殊",
    "special.slime": "星墓咒法",
    "special.blue_slime": "裂隙甲殼",
    "special.vine": "石爪壓迫",
    "special.mushroom": "日蝕干擾",
    ...
    "enemy.slime.name": "砂墓木乃伊祭司",
    "enemy.slime.trait": "星墓咒法",
    "enemy.blue_slime.name": "聖甲蟲斥候",
    "enemy.blue_slime.trait": "裂隙甲殼",
    "enemy.vine.name": "瑪雅石雕幼獸",
    "enemy.vine.trait": "裂隙石爪",
    "enemy.mushroom.name": "瑪雅日蝕祭司",
    "enemy.mushroom.trait": "日蝕咒印",
    "enemy.beetle.name": "阿努比斯裂隙守衛",
    ...
    "enemy.king.name": "亞特蘭提斯水晶神殿哨兵",
    "enemy.king.trait": "Boss：深淵壓迫",
  },
  en: {
    startTitle: "T-Spin Traveler",
    ...
    "special.slime": "Star tomb hex",
    "special.blue_slime": "Rift carapace",
    "special.vine": "Stone claw pressure",
    "special.mushroom": "Eclipse interference",
    ...
    "enemy.slime.name": "SAND TOMB MUMMY PRIEST",
    "enemy.slime.trait": "STAR TOMB HEX",
    "enemy.blue_slime.name": "SCARAB SCOUT",
    "enemy.blue_slime.trait": "RIFT CARAPACE",
    "enemy.vine.name": "MAYA STONE BEAST SCOUT",
    "enemy.vine.trait": "RIFT STONE CLAW",
    "enemy.mushroom.name": "MAYA ECLIPSE PRIEST",
    "enemy.mushroom.trait": "ECLIPSE HEX",
    "enemy.beetle.name": "ANUBIS RIFT GUARD",
    ...
    "enemy.king.name": "ATLANTIS CRYSTAL TEMPLE SENTINEL",
    "enemy.king.trait": "BOSS: ABYSS PRESSURE",
  },
};
