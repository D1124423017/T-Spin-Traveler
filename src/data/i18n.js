export const translations = {
  zh: {
    ...
    equipmentNoaPreviewHint: "第一版保留角色原始外觀，已穿戴效果會記錄於裝備槽。",
    ...
    equipmentInventoryControlsHint: "← / → 分類　↑ / ↓ 選擇　Enter / E 穿戴　R 輪盤　Esc 主選單",
    ...
    equipmentOwnedTitle: "已擁有裝備 {count} / 15",
  ...
  en: {
    ...
    equipmentNoaPreviewHint: "Version 1 keeps NOA's original appearance while equipped gear is tracked by slot.",
    ...
    equipmentInventoryControlsHint: "Left / Right Filter   Up / Down Select   Enter / E Equip   R Roulette   Esc Menu",
    ...
    equipmentOwnedTitle: "OWNED EQUIPMENT {count} / 15",
