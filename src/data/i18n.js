export const translations = {
  zh: {
    ...
    menuHeroHover1: "裂隙很安靜，適合練習 T-Spin。",
    menuHeroHover2: "我會把你的消行轉成戰鬥指令。",
    menuHeroHover3: "準備好了，就從無盡模式出發。",
    menuHeroClick1: "收到。方塊會聽你的指令。",
    menuHeroClick2: "魔力穩定，鍵盤也準備好了。",
    menuHeroClick3: "別擔心，我會看著盤面。",
    paused: "暫停",
    pauseMenu: "暫停選單",
  ...
  en: {
    ...
    menuHeroHover1: "The rift is quiet. Good timing for T-Spins.",
    menuHeroHover2: "I will turn your clears into battle commands.",
    menuHeroHover3: "When you are ready, Endless is waiting.",
    menuHeroClick1: "Signal received. The blocks will follow.",
    menuHeroClick2: "Magic is stable. Keyboard is ready.",
    menuHeroClick3: "Do not worry. I am watching the board.",
    paused: "Paused",
