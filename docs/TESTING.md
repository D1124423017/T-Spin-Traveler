...
- [ ] NOA rift wayfinder idle sprite sheet plays on the menu.
- [ ] NOA star map listener idle sprite sheet plays on the menu.
...
- [ ] Future Maya and Atlantis assets remain outside active gameplay routing.

## Background Progression

- [ ] Wave 1 uses the Egyptian star tomb exterior rift background.
- [ ] Later Egypt stages rotate through the pyramid observatory and star tomb backgrounds.
- [ ] Boss presentation uses the Egypt boss background override without breaking readability.
- [ ] Maya and Atlantis backgrounds remain future content and are not selected by current stage routing.
- [ ] Backgrounds are dimmed enough to keep the board, HUD, and text readable.

## Audio

- [ ] Menu music starts after browser audio unlock.
- [ ] The temporary six-track global BGM rotation advances without playback errors.
- [ ] Menu, battle, boss, and upgrade modes preserve the current global rotation behavior.
