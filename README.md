...
- Falling block puzzle gameplay  
  下落方塊消除玩法

- Fantasy RPG battle system  
  奇幻 RPG 戰鬥系統

- Line clear and combo-based attacks  
  消除與連擊觸發攻擊
...
- Enemy HP and battle feedback  
  敵人血量與戰鬥回饋

- Melee, ranged, combo, and ultimate attack effects  
  近戰、遠程、連擊與大招攻擊效果

- HTML Canvas-based web prototype  
  以 HTML Canvas 製作的網頁遊戲原型
...
| ← / → | Move｜左右移動 |
| ↓ | Soft Drop｜加速下落 |
| Space | Hard Drop｜快速落下 |
| ↑ / X | Rotate｜旋轉 |
| Z | Rotate Counterclockwise｜逆時針旋轉 |
| A | 180° Rotate｜180 度旋轉 |
| Shift / C | Hold｜暫存方塊 |
| P | Pause｜暫停 |
| M | Toggle Music｜切換音樂 |
...
This project is currently a playable HTML Canvas prototype.

本專案目前是一個可遊玩的 HTML Canvas 遊戲原型。

### Current Focus｜目前重點

- Core falling block controls  
  核心方塊操作

- Combat feedback  
  戰鬥回饋

- Character attack animation timing  
  角色攻擊動畫節奏
...
- UI readability and game feel  
  UI 可讀性與遊戲手感

### Future Improvements｜未來預計優化
